...
async def searchAds(session, page, countary,querry, forward_cursor, backward_cursor, collation_token, start_date , end_date, ad_status_type, ad_type, media_type, content_languages , publisher_platforms) :
    session_id = '69099722-d5dc-4c23-8ed1-892643ae1e6b'
    cookies = {
        'wd': '1470x524',
        'presence': 'C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1712765141879%2C%22v%22%3A1%7D',
        'fr': '1dxsvlXAtvFRRv5Zt.AWWdPt7x76KrxriPXWHIiE4IaiY.BmFri4..AAA.0.0.BmFrjT.AWUqWJvS53k',
        'c_user': '100077032827932',
        'xs': '42%3Ay6vfvkFSOHXutg%3A2%3A1712693919%3A-1%3A-1%3A%3AAcWkJzp_CfhwVBSR_Ut6J5GxMNTJdKQ6xnodgkB4aw',
    ...
    headers = {
        ...
        # 'Cookie': 'wd=1470x524; presence=C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1712765141879%2C%22v%22%3A1%7D; fr=1dxsvlXAtvFRRv5Zt.AWWdPt7x76KrxriPXWHIiE4IaiY.BmFri4..AAA.0.0.BmFrjT.AWUqWJvS53k; c_user=100077032827932; xs=42%3Ay6vfvkFSOHXutg%3A2%3A1712693919%3A-1%3A-1%3A%3AAcWkJzp_CfhwVBSR_Ut6J5GxMNTJdKQ6xnodgkB4aw; sb=fMb5ZeOdkMH3vrgtLFC2fAxx; datr=3l0QZp40Kmki9hqKpYpH2eX7; locale=en_GB; dpr=2; ps_l=0; ps_n=0',
        'X-FB-LSD': 'kjUaWG10FXvbX65OSxyvX3',
        'X-ASBD-ID': '129477',
    }
    ...
    '__a': '1',
    '__req': '1e',
    '__hs': '19823.BP:DEFAULT.2.0..0.0',
    'dpr': '2',
    '__ccg': 'GOOD',
    '__rev': '1012673473',
    '__s': 'zb6nhs:3yljj6:ysfpuu',
    '__hsi': '7356270285150372324',
    ...
    '__csr': '',
    'fb_dtsg': 'NAcMoqy2FzygPRTygu966a6-FySgQ19qXeP4tD_ljqwVWyj48YoxQUQ:42:1712693919',
    'jazoest': '25622',
    'lsd': 'kjUaWG10FXvbX65OSxyvX3',
    '__spin_r': '1012673473',
    '__spin_b': 'trunk',
    '__spin_t': '1712765145',
    '__jssesw': '1',
...
async def viewad(session, adArchiveID, pageID, countary):
    ...
    variables = {
        ...
        "pageID": pageID,
        "country": countary,
        "sessionID": "69099722-d5dc-4c23-8ed1-892643ae1e6b",
        "source": None,
