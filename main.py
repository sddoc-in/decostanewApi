...
async def searchAds(session, page, countary,querry, forward_cursor, backward_cursor, collation_token, start_date , end_date, ad_status_type, ad_type, media_type, content_languages , publisher_platforms) :
    session_id = 'c9618af2-c655-476e-87ef-5eea881d16bf'
    cookies = {
          'wd': '1467x524',
            'c_user': '100077032827932',
            'fr': '1LJDdivCoN9wKMJMq.AWVLLM1MuUz5PJ4VC0A-lFwCkX8.BmDTMD..AAA.0.0.BmDTMD.AWV51_8jq4M',
            'xs': '1%3A4sihRnxP-i1adQ%3A2%3A1711718431%3A-1%3A-1%3A%3AAcW2m9IT3lYmMe1IWzMaiqB_Je2-rZeKikNeg3fJdQ',
    ...
    'Referer': 'https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=NL&q=t-shirt&sort_data[direction]=desc&sort_data[mode]=relevancy_monthly_grouped&search_type=keyword_unordered&media_type=all',
    # 'Content-Length': '584',
    'Connection': 'keep-alive',
    'Sec-Fetch-Dest': 'empty',
    # 'Cookie': 'wd=1467x524; c_user=100077032827932; fr=1LJDdivCoN9wKMJMq.AWVLLM1MuUz5PJ4VC0A-lFwCkX8.BmDTMD..AAA.0.0.BmDTMD.AWV51_8jq4M; xs=1%3A4sihRnxP-i1adQ%3A2%3A1711718431%3A-1%3A-1%3A%3AAcW2m9IT3lYmMe1IWzMaiqB_Je2-rZeKikNeg3fJdQ; usida=eyJ2ZXIiOjEsImlkIjoiQXNiZDFzbXlmOHkxNCIsInRpbWUiOjE3MTIxMzc5MzB9; presence=C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1712137441538%2C%22v%22%3A1%7D; sb=fMb5ZeOdkMH3vrgtLFC2fAxx; locale=en_GB; dpr=2; ps_l=0; ps_n=0; datr=ZY32ZYVf1hlBh3gAthGa1xZX',
    'X-FB-LSD': '0TbAkAQLzoh7tMWvLp6J8B',
    'X-ASBD-ID': '129477',
    }
    ...
    '__ccg': 'GOOD',
    '__rev': '1012507292',
    '__s': 'reqjid:jfokgv:w8uqye',
    '__hsi': '7353603049584025159',
    ...
    '__csr': '',
    'fb_dtsg': 'NAcP-CfxX3D-jWV9TI7scZnK5_PSXeepXhzvNU3Z5tCGYZvRAUeWpeA:1:1711718431',
    'jazoest': '25375',
    'lsd': '0TbAkAQLzoh7tMWvLp6J8B',
    '__spin_r': '1012507292',
    '__spin_b': 'trunk',
    '__spin_t': '1712144131',
    '__jssesw': '1',
...
async def viewad(session, adArchiveID, pageID, countary):
    ...
    variables = {
        ...
        "pageID": pageID,
        "country": countary,
        "sessionID": "c9618af2-c655-476e-87ef-5eea881d16bf",
        "source": None,
