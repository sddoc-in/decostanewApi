...
async def searchAds(session, page, countary,querry, forward_cursor, backward_cursor, collation_token) :
    cookies = {
         'wd': '1470x414',
        'presence': 'C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1711718439369%2C%22v%22%3A1%7D',
        'fr': '1QXa8HCZpV8e3QuMZ.AWVAn1DLeer9Kux-Bw3E6eTp20I.Bl-gav..AAA.0.0.BmBsAi.AWVQRCB4c7g',
        'c_user': '100077032827932',
        'sb': 'fMb5ZeOdkMH3vrgtLFC2fAxx',
        'xs': '1%3A4sihRnxP-i1adQ%3A2%3A1711718431%3A-1%3A-1',
        'locale': 'en_GB',
        'dpr': '2',
        'ps_l': '0',
        'ps_n': '0',
    ...
    headers = {
        ...
        'Referer': 'https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=IN&q=korting&sort_data[direction]=desc&sort_data[mode]=relevancy_monthly_grouped&search_type=keyword_unordered&media_type=all',
        # 'Content-Length': '584',
        'Connection': 'keep-alive',
        'Sec-Fetch-Dest': 'empty',
        # 'Cookie': 'wd=1470x414; presence=C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1711718439369%2C%22v%22%3A1%7D; fr=1QXa8HCZpV8e3QuMZ.AWVAn1DLeer9Kux-Bw3E6eTp20I.Bl-gav..AAA.0.0.BmBsAi.AWVQRCB4c7g; c_user=100077032827932; sb=fMb5ZeOdkMH3vrgtLFC2fAxx; xs=1%3A4sihRnxP-i1adQ%3A2%3A1711718431%3A-1%3A-1; locale=en_GB; dpr=2; ps_l=0; ps_n=0; datr=ZY32ZYVf1hlBh3gAthGa1xZX',
        'X-FB-LSD': 'PJ3fgGtJjMxEtxWg7A4viU',
        'X-ASBD-ID': '129477',
        'Priority': 'u=3, i',
    }
    ...
    data = {
        ...
        '__a': '1',
        '__req': 'e',
        '__hs': '19811.BP:DEFAULT.2.0..0.0',
        'dpr': '2',
        '__ccg': 'GOOD',
        '__rev': '1012411673',
        '__s': 'yujhtq:xhbz8e:kgcxre',
        '__hsi': '7351774849235397230',
        ...
        '__csr': '',
        'fb_dtsg': 'NAcOSoqkWvrpgcvsMnXByhFse2zDos8jBz90sA24s3i4FpRcjC-nSDw:1:1711718431',
        'jazoest': '25619',
        'lsd': 'PJ3fgGtJjMxEtxWg7A4viU',
        '__spin_r': '1012411673',
        '__spin_b': 'trunk',
        '__spin_t': '1711718470',
        '__jssesw': '1',
    ...
    if page == 1:
        ...
        url = f'https://www.facebook.com/ads/library/async/search_ads/?q={querry}&forward_cursor={forward_cursor}&{backward_cursor}=&session_id=15b5fb0b-2d87-4f6c-93a9-d56031103033&collation_token={collation_token}&count=30&active_status=all&ad_type=all&countries[0]={countary}&media_type=all&search_type=keyword_unordered'
        response = await fetch(session,  url, headers=headers,cookies=cookies, data=data)
...
async def viewad(session, adArchiveID, pageID, countary):
    cookies = {
       'wd': '1470x414',
        'fr': '1QXa8HCZpV8e3QuMZ.AWUDaYo6oCpvLdoc6jjVbicBII8.Bl-gav..AAA.0.0.BmBsKS.AWVCuu_Qw8o',
        'c_user': '100077032827932',
        'sb': 'fMb5ZeOdkMH3vrgtLFC2fAxx',
        'xs': '1%3A4sihRnxP-i1adQ%3A2%3A1711718431%3A-1%3A-1',
        'locale': 'en_GB',
    ...
    data = {
        ...
        '__ccg': 'EXCELLENT',
        '__rev': '1012411673',
        '__s': 'nrle9r:lhh5ip:gqzrfh',
        '__hsi': '7351778084826661599',
        '__dyn': '7xeUmxa3-Q8zo5ObwKBAgc9o9E6u5U4e1FxebzEdF8ixy7EiwvoWdwJwCwfW7oqx60Vo1upEK12wvk1bwbG78b87C2m3K2y11wBz81s8hwGwQwoE2LwBgao884y0Mo6i588Egze2a5E5afK1LwPxe3C0D8sKUbobEaUiyE725U4q0HUkyE1bobodEGdw46wbLwrU6C2-0z85C1Iwqo1187i',
        '__csr': '',
        'fb_dtsg': 'NAcM21AevIm8vTDP3u8dlxeGTrwApolF-3UEs7XiUaC9M88kbxhgDHA:1:1711718431',
        'jazoest': '25321',
        'lsd': '1L_LMRQOPL7nrHRSCeN4G6',
        '__spin_r': '1012411673',
        '__spin_b': 'trunk',
        '__spin_t': '1711719223',
        '__jssesw': '1',
